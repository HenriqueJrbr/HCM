...
class SolicitacaoAcessoGrupo extends Model
{
     ...
     * @return type
     */
    public function carregaGrupoProgramas($idGrupos, $idUsuario)
    {
        $sql = "
            SELECT                              
                (SELECT 
    ...
    public function validaSolicitacaoAberta($post)
    {
        $sql = '            
            ...
            WHERE 
                ...
                AND JSON_CONTAINS(d.documento, \'{"idGrupo": "'.$post['idGrupo'].'"}\', \'$.grupos\')';
