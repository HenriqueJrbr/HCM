...
class solicitacao_acesso extends revisao_de_acesso_aprovacao
{
    ...
    public function solicitacao_acesso($control, $idSolicitacao, $idAtividade = '', $fluxo = '', $idMovimentacao = '', $post, $from = '')
    {
    ...
    {        
        ...
        $dados['from']           = $view;
        $dados['gestMrp']        = ['18' => 'gestorModulo', '19' => 'gestorRotina', '20' => 'gestorPrograma'];
        ...
        $dados['seqAprov'] = $this->preparaSeqAprovacao(4);                
        // Fim sequencia de aprovação        
        //$helper->debug($dados['seqAprov'], true);
