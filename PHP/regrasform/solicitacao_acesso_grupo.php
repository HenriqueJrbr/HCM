...
class solicitacao_acesso_grupo extends revisao_de_acesso_aprovacao
{
    ...
    public function solicitacao_acesso_grupo($control, $idSolicitacao, $idAtividade = '', $fluxo = '', $idMovimentacao = '', $post, $from = '')
    {
    ...
    {        
        ...
        $dados['from']           = $view;
        $dados['gestMrp']        = ['34' => 'gestorModulo', '35' => 'gestorRotina', '36' => 'gestorPrograma'];
        ...
        $dados['seqAprov'] = $this->preparaSeqAprovacao(6);
