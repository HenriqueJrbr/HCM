...
if($sql->rowCount() > 0):
    ...
    foreach($movimentacoes as $valMov):
        ...
        * Se DataAtual >= (dataMovimentacao + diasAtraso) && status == 0                                                    *
        ********************************************************************************************************************/
        if(strtotime(date('Y-m-d')) > strtotime($dataExpira)):
                ...
                $mensagem = "<!DOCTYPE html>
                    <html>
                        ...
                        <body>  
                            ...
                            <p>Após $diasNotifica notificações, informamos que os acessos do usuário ".$dadosEmailUsuario['nome_usuario']." foram removidos por falta de aprovação.</p>
        ...
        ********************************************************************************************************************/
        //if((strtotime(date('Y-m-d')) >= strtotime($iniciaNotificacao)) && strtotime(date('Y-m-d')) <= strtotime($dataExpira)):
