...
<div class="col-md-12 col-sm-12 col-xs-12">
    <ol class="breadcrumb">
		...
		<li><a href="<?php echo URL ?>/manutencao/funcao"><font style="vertical-align: inherit;" onclick="loadingPagia()"><font style="vertical-align: inherit;">Função</font></font></a></li>
        <li class="active"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Importar gestores de módulos</font></font></li>
    </ol>
</div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Importar<small> Gestores de módulos</small></h2>
            ...
            <div class="x_content">				
				...
				<div class="row">
					<div class="col-md-12">
						<a class="btn btn-danger" id="exportExcel">
							<i class="fa fa-file-excel-o"></i> Baixar arquivo csv de exemplo para importação
						</a>
					</div>	
				</div>
				<br>
				...
				<div class="row">
					<form action="<?php echo URL; ?>/Carga/gestorModulo" id="frmSincroniza" method="post"> 
                        <input type="hidden" name="analise" value="0">
                        <input type="hidden" name="csvFile" value="<?php echo isset($csvFile) ? $csvFile : '' ; ?>">
						<div class="col-md-12">
							<label><br></label>
            ...
            <div class="x_content">                                                                                
                <div class="row <?php echo (!isset($inicio)) ? 'hide' : '' ?>" id="result">		
                    ...
                    <?php if(isset($totCadastrados)): ?>
                        <div class="col-md-2">
                            <strong class="infosfluxos">Já cadastrados:</strong> <strong><?php echo $totCadastrados; ?></strong>
                        </div>
                    <?php endif; ?>
                    <?php if(isset($totNaoCadastrados)): ?>
                        <div class="col-md-3">
                            <strong class="infosfluxos">Não cadastrados:</strong> <strong><?php echo $totNaoCadastrados; ?></strong>
                        </div>
                    <?php endif; ?>
                    <?php if(isset($totEliminados)): ?>
                        <div class="col-md-3">
                            <strong class="infosfluxos">Cadastrados a remover:</strong> <strong><?php echo $totEliminados; ?></strong>
                        </div>
                    <?php endif; ?>
                </div>                                                                
                                ...
                                <table class="tabela table table-striped hover table-striped dt-responsive nowrap dataTable no-footer dtr-inline"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                            ...
                                            aria-label="Last name: activate to sort column ascending">Gestor
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                            rowspan="1" colspan="1" style="width: 10px;"
                                            aria-label="Last name: activate to sort column ascending">Módulo
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
							...
							<table class="table table-striped hover table-striped dt-responsive nowrap dataTable no-footer dtr-inline"
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="<?php echo URL . '/cargas/sincronizados/' . str_replace('.', '.csv_diff.', $log['anexo']); ?>" download="cargaSGA.csv" class="btn btn-success">Download CSV</a></td>
									</tr>
									<?php endforeach; ?>
								</tbody>
							</table>
...
<script>
	$('#exportExcel').on('click', function(){
		location.href = url + "programa_progress/funcoes.csv";
	});
