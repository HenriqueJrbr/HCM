...
<div class="col-md-12 col-sm-12 col-xs-12">
    <ol class="breadcrumb">
        ...
        <li class="active"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Importar gestores de usuários</font></font></li>
    </ol>
</div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Importar<small> Gestores de usuários</small></h2>
            ...
            <div class="x_content">				
				...
				<div class="row">
					<form action="<?php echo URL; ?>/Carga/gestorUsuario" id="frmSincroniza" method="post"> 
                                ...
                                <table class="tabela table table-striped hover table-striped dt-responsive nowrap dataTable no-footer dtr-inline"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                            ...
                                            aria-label="Last name: activate to sort column ascending">Cód. Função
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
