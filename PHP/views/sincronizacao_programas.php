...
<div class="col-md-12 col-sm-12 col-xs-12">
    <ol class="breadcrumb">
        ...
        <li class="active"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Programas</font></font></li>
    </ol>
</div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Sincronização<small> Programas</small></h2>
            ...
            <div class="x_content">
				...
				<div class="row">
					<form action="<?php echo URL; ?>/Sincronizacao/sincronizaProgramas" id="frmSincroniza" method="post">                            
						<div class="col-md-12">
							<label><br></label>
