...
<div class="col-md-12 col-sm-12 col-xs-12">
    <ol class="breadcrumb">
        ...
        <li class="active"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Programas vs Empresas</font></font></li>
    </ol>
</div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Sincronização <small> Programas vs Empresas</small></h2>
            ...
            <div class="x_content">
				...
				<div class="row">
					<form action="<?php echo URL; ?>/Sincronizacao/sincronizaProgramasEmpresas" id="frmSincroniza" method="post">						
						<div class="col-md-12">
							<label><br></label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Os dados serão sincronizados para a instância <strong><?php echo $_SESSION['empresaDesc']; ?></strong>.<br>
                Tem certeza que deseja continuar a sincronização?</div>
            <!-- dialog buttons -->
