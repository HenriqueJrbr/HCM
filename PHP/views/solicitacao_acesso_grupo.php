<style>
    ...
    <form action="<?php echo $url ;?>" method="POST" id="frmFluxo" enctype="multipart/form-data">
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>Fluxo de solicitação de acesso por grupo</h2>
            ...
            <div class="row">
                <?php if(isset($documento->gruposSolicitados)):?>
                <div class="col-md-12">                                               
                    <h2>Grupos Solicitados</h2>
                    <div class="clearfix"></div>
                            ...
                            <div class="col-sm-12">
                                <table class="tabelaRevisao table table-striped table-bordered dataTable no-footer"
                                    ...
                                    <tbody class="progsAdicionados">
                                        <?php foreach($documento->gruposSolicitados as $key => $val): ?>
                                        <tr>
                                            <td><input type="hidden" name="grupo[<?php echo $key; ?>][idGrupo]" class="idProg" value="<?php echo $val->idGrupo; ?>"><input type="hidden" name="grupo[<?php echo $key; ?>][idLegGrupo]" value="<?php echo $val->idLegGrupo; ?>"><?php echo $val->idLegGrupo; ?></td>
                                            <td><input type="hidden" name="grupo[<?php echo $key; ?>][descAbrev]" value="<?php echo $val->descAbrev; ?>"><?php echo $val->descAbrev; ?></td>
                                            <td><?php echo $val->obsGrupo; ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
