    ...
    <form action="<?php echo $url ;?>" method="POST" id="frmFluxo" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <input type="hidden" name="idLegGrupo" id="idLegGrupo" value="<?php echo $documento->idLegGrupo ?>">
                <input type="hidden" name="descAbrev" id="descAbrev" value="<?php echo $documento->descAbrev ?>">
                <input type="hidden" name="idGrupo" id="idGrupo" value="<?php echo $documento->idGrupo ?>">
                <input type="hidden" name="nomeGestor" id="nomeGestor" value="<?php echo $documento->nomeGestor ?>">
                <input type="hidden" name="codGest" id="codGest" value="<?php echo $documento->codGest ?>">
                <input type="hidden" name="idCodGest" id="idCodGest" class="form-control" value="<?php echo $documento->idCodGest; ?>">
            </div>
        </div>
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>Fluxo de solicitação de programa em grupo</h2>
            ...
            <div class="row">                
                <div class="col-md-4">
                    Grupo:
                    <strong class="infosfluxos"><?php echo $documento->idLegGrupo ?></strong>
                </div>
                <div class="col-md-4">
                    Descrição:
                    <strong class="infosfluxos"><?php echo $documento->descAbrev ?></strong>
                </div>
                <div class="col-md-4">
                    Gestor do Grupo:
                    <strong class="infosfluxos"><?php echo $documento->nomeGestor ?></strong>
                </div>
            </div>
            <div class="row hide">
                <div class="col-md-6">
...
<!--            </div>-->
            ...
            <div class="x_content">                
                ...
                <div class="clearfix"></div>
                <?php require 'inc/fluxos_aprovacao_grupo_programa.php'; ?>

                <div class="clearfix"><hr></div>
                <?php require 'inc/fluxos_overview_grupo_programa.php'; ?>
