        ...
        <div class="animate form login_form">
            ...
            <form method="POST">
              ...
              <br>
               <div class="row">
                  <div class="col-md-6">
                    <input type="submit" name="acessar" class="btn btn-default form-control" value="Continuar"/>
                  </div>
                  <div class="col-md-6">
                    <button type="button" class="btn btn-default form-control"  id="recuperaSenha" name="recuperaSenha" onclick="novaSenha()">Voltar</button>
                  </div>
              </div>
            </form>
